...
const IMGS = {
  ...
  encuentro:   "/redes_uno.jpeg",        // Dos tazas — franja cita
  campo:       "/redes_dos.jpeg",        // Naturaleza / planta
  andes:       "/redes_tres.jpeg",       // Cordillera andina
  elcielo:     "/redes_cinco.jpeg",      // El Cielo — árboles
  empaque2:    "/presentacion_empaque_dos.jpeg", // Bolsa limpia
}
