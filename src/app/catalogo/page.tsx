...
function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 md:px-14 transition-all duration-500"
      style={{
        height: 68,
        background: scrolled ? "rgba(8,4,2,0.92)" : "transparent",
        backdropFilter: scrolled ? "blur(20px)" : "none",
        borderBottom: scrolled ? "1px solid rgba(255,240,210,0.05)" : "none",
      }}>
